...
void UNAP::matrix::solver::SET_minIter(label minIter) { minIter_ = minIter; }

void UNAP::matrix::solver::SET_relTol(scalar relTol) { relTol_ = relTol; }
...
void UNAP::matrix::solver::SET_ifPrint(bool ifPrint) { ifPrint_ = ifPrint; }
