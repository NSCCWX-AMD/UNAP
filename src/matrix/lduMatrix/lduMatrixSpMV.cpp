...
void UNAP::lduMatrix::spMV(scalarVector &Apsi, const scalarVector &psi) const
{
  ...
  forAll(cellI, nCells) { ApsiPtr[cellI] = 0.0; }
  ...
  if (unatIter_)
  {
    ...
    constructSingleArray(backEdgeData, 1, nFaces, COPYIN, (swFloat *)lowerPtr);
    constructSingleArray(frontEdgeData, 1, nFaces, COPYIN, (swFloat *)upperPtr);
    constructSingleArray(selfConnData, 1, nCells, COPYIN, (swFloat *)diagPtr);
    constructSingleArray(vertexData, 1, nCells, COPYIN, (swFloat *)psiPtr);
    addSingleArray(vertexData, 1, nCells, COPYOUT, (swFloat *)ApsiPtr);
    ...
    FieldData data_p = {
        &backEdgeData_p, &frontEdgeData_p, &selfConnData_p, &vertexData_p};
