...
extern "C"
{
   ...
   *               node @a p.
   */
  extern void RCM_FUNC(genrcmi)(const int n,
                                const int flags,
                                const int *xadj,
                                const int *adj,
                                int *perm,
   ...
   */
  extern void RCM_FUNC(genrcml)(const long n,
                                const int flags,
                                const long *xadj,
                                const long *adj,
                                long *perm,
  ...
  extern void RCM_FUNC(fnrooti)(int *root,
                                const int flags,
                                const int *xadj,
                                const int *adj,
                                const int *deg,
   ...
   */
  extern void RCM_FUNC(fnrootl)(long *root,
                                const int flags,
                                const long *xadj,
                                const long *adj,
                                const long *deg,
  ...
  extern void RCM_FUNC(rcmi)(const int root,
                             const int flags,
                             const int *xadj,
                             const int *adj,
                             const int *deg,
   ...
   */
  extern void RCM_FUNC(rcml)(const long root,
                             const int flags,
                             const long *xadj,
                             const long *adj,
                             const long *deg,
