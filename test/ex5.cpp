...
//- test for lduMatrix
//- using PBiCGStab to solve a 2D Poisson equation
...
int main()
{
  ...
  // UNAPCOUT << "Number of non zeros in upper coefficients is " << nZeros <<
  // ENDL;
  ...
  const lduMatrix lduA(nCells, lowerAddr, upperAddr, lower, diag, upper);
